...
| Pragma shows fewer than 270 experts | Bundle file hash, project resource count, capability count | Re-run `verify_pragma_agency.ps1`; if the fingerprint is absent, import `agency-agents-all.pragma` again with `copy` conflict policy. |
